/**
 * @file lv_conf.h
 * LVGL PC simulator configuration for pc_simulator_lgfx.
 ...
 * 注：本工程 LV_USE_SDL=0（显示走 LovyanGFX Panel_sdl、lv_sdl 不编译），故本项实际不生效，
 * 仅为与复制来源 pc_simulator/lv_conf.h 保持一致而保留。 */
